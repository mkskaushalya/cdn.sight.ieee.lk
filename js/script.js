...
$(document).ready(function(){
  ...
  let interval = 2000;
    ...
    valueDisplays.forEach((valueDisplay) => {
      let startValue = 0;
      let endValue = parseInt(valueDisplay.getAttribute("count-val"));
    ...
    $("#contformsubmit").click(function(event){
        ...
        var localGetURL = "/inc/run/action.php?contformsubmit=contformsubmit&contname="+ contname + "&contemail=" + contemail + "&contphone=" + contphone + "&contsubject=" + contsubject + "&contmessage=" + contmessage;
